...
function _element102_struct($el) {
	return array(
		'num_1'   => _num($el['num_1']),//[13] id элемента: список, на который воздействует фильтр
		'txt_1'   => $el['txt_1'],      //нулевое значение
		'txt_2'   => $el['txt_2'],      //[13] ids элементов: привязанный список (зависит от num_1)
		'txt_3'   => $el['txt_3'],      //[13] ids элементов: счётчик количеств  (зависит от num_1)
		'txt_4'   => $el['txt_4'],      //[13] ids элементов: путь к цветам (зависит от num_1)
		'txt_5'   => $el['txt_5']       //[40] значение по умолчанию
	) + _elementStruct($el);
}
