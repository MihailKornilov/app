...
$.fn._dropdown = function(o) {//выпадающий список в виде ссылки
	...
	HEAD.on('click mouseenter', function() {//открытие списка
		$('._dropdown').removeClass('rs');
		timerClear();
